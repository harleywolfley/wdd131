...
function togglePaymentDetails(e) {
  ...
  const paypalUserContainer = document.querySelector("#paypalUserContainer");

  // Hide payment containers by adding the '.hide' class to each of them
  creditCardContainer.classList.add("hide");
  paypalUserContainer.classList.add("hide");
  ...
  paypalUserContainer.removeAttribute("required");
  ...
  if (e.target.value === "credit") {
    ...
    paypalUserContainer.classList.remove("hide");
